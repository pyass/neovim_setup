cd /opt && sudo wget https://github.com/neovim/neovim/releases/download/v0.8.3/nvim-linux64.tar.gz && sudo tar xvzf nvim-linux64.tar.gz  && sudo ln -s /opt/nvim-linux64/bin/nvim /usr/local/bin

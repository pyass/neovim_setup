cd /opt && wget https://github.com/neovim/neovim/releases/download/v0.8.0/nvim-linux64.tar.gz  && tar xvzf nvim-linux64.tar.gz  && ln -s /opt/nvim-linux64/bin/nvim /usr/local/bin
